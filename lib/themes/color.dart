...
const PrimaryColor = const Color(0xFF050021);
const PrimaryColorLight = const Color(0xFF2c2c48);
const PrimaryColorDark = const Color(0xFF000000);

const SecondaryColor = const Color(0xFFb2dfdb);
const SecondaryColorLight = const Color(0xFFe6ffff);
